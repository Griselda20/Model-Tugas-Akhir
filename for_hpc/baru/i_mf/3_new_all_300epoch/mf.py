...
class ValTinyImageNetDataset(Dataset):
    def __init__(self, transform=None):
        ...
        train_files = glob.glob("/home/tasi2425111/resized_imagenet/train/*/*.JPEG")
        ...
        self.cls_dic = {}
        for i, line in enumerate(open('/home/tasi2425111/resized_imagenet/val/val_annotations.txt', 'r')):
            a = line.split('\t')
            img, cls_id = a[0], a[1]
...
# checkpoint = torch.load("/home/tasi2425111/for_hpc/baru/ti_mf/8_continue_train_newest_dataset_200epochs/best_model_mobile_former.pth", map_location=device)
